...
export default function Hero() {
    return (
        <div className="w-full min-h-screen bg-pink/10 bg-[url('/dots.png')] bg-no-repeat bg-left bg-origin-content">
            <Navbar />
            <div className="w-full h-full mt-20 px-4 lg:px-20 py-4 lg:py-8 sm:p-8">
                <div className="w-full h-full flex flex-col lg:flex-row items-center justify-center lg:space-x-[200px] space-y-5 lg:space-y-0">
                    <div className="lg:w-[700px] xl:w-[500px] text-center lg:text-left space-y-2">
